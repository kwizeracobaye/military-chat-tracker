      ...
      <main className="pt-24 lg:pl-64 pb-6 transition-all duration-300">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <h1 className="text-2xl md:text-3xl font-semibold tracking-tight">Navigation Operations</h1>
          ...
          <Tabs defaultValue="exercises" value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="exercises">Active Exercises</TabsTrigger>
              ...
              <div className="bg-card rounded-lg border shadow-sm overflow-hidden">
                <div className="p-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Real-time navigation map showing routes, checkpoints, and points of interest.
                    Default location set to Gako Military Academy, Bugesera District, Rwanda.
                  </p>
                </div>
                
                <OpenStreetMap height="600px" className="px-6 pb-6" />
              </div>
            </TabsContent>
          </Tabs>
        </div>
